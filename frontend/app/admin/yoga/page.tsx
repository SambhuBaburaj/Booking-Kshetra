      ...
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Yoga Sessions</h1>
              <p className="text-gray-600">Manage your yoga teacher training programs</p>
            </div>
            <button
              ...
              <div className="p-6">
                <div className="flex items-center justify-between mb-6">
                  <h2 className="text-xl font-semibold text-gray-900">
                    {editingSession ? 'Edit Yoga Session' : 'Add New Yoga Session'}
                  </h2>
                  <button
                    onClick={() => {
                      setShowModal(false);
